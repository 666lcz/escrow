...
impl Processor {
    ...
    fn process_exchange(
        ...
        // transfer from taker's send account to initializer receive account
        let token_program = next_account_info(account_info_iter)?;
        ...
        // transfer PDA token account balance to taker's receive account
